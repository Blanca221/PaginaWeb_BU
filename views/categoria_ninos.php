<!-- Página de categoría Niños -->
<div class="container-fluid px-0">
    <!-- Slider principal -->
    <div id="carouselCategoriaNinos" class="carousel slide" data-bs-ride="carousel">
        <div class="carousel-inner">
            <?php foreach ($sliderImagenes as $index => $imagen): ?>
                <div class="carousel-item <?= $index === 0 ? 'active' : '' ?>">
                    <img src="<?= $imagen ?>" class="d-block w-100" alt="Moda niños">
                </div>
            <?php endforeach; ?>
        </div>
        <button class="carousel-control-prev" type="button" data-bs-target="#carouselCategoriaNinos" data-bs-slide="prev">
            <span class="carousel-control-prev-icon" aria-hidden="true"></span>
            <span class="visually-hidden">Anterior</span>
        </button>
        <button class="carousel-control-next" type="button" data-bs-target="#carouselCategoriaNinos" data-bs-slide="next">
        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <a href="/PaginaWeb_BU/resource_productos.php?categoria=ninos" class="text-decoration-none text-dark">Ver Todo</a>
                </div>
            </div>
        </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        var myCarousel = new bootstrap.Carousel(document.querySelector('#carouselCategoriaNinos'), {
            interval: 5000
        });
    });
</script> 